...
#===================Python Variables=======================
menu_category = ["Tea & Coffee","Snacks","Roll Rumali","Chaap Tawa","WJW DAL HANDI","Main Course","WJW SPL. COMBO","WJW Thali",
                 "Platters",
                 "Rice","Raita","Roti/Naan","Chinese","WJW Pasta","Burger","Pizza","Beverages","Dessert"]

menu_category_dict = {"Tea & Coffee":"1 Tea & Coffee.txt","Snacks":"2 Snacks.txt",
                "Roll Rumali":"3 Rumali.txt","Chaap Tawa":"4 Tawa.txt",
                "WJW DAL HANDI":"5 Handi.txt","Main Course":"6 Main Course.txt","WJW SPL. COMBO": "7 Combo.txt",
                "WJW Thali": "8 Thali.txt","Platters": "9 Platters.txt",
                "Rice": "10 Rice.txt","Raita": "11 Raita.txt",
                "Roti/Naan": "12 Roti-Naan.txt","Chinese": "13 Chinese.txt",
                "Pasta": "14 Pasta.txt","Burger":"15 Burger.txt",
                "Pizza":"16 Pizza.txt","Beverages":"17 Beverages.txt","Dessert":"18 Dessert.txt"}
...
root.title("Welcome to Wah Ji Wah Restaurant")
...
title_label = Label(title_frame, text="Wah Ji Wah Restaurant",
                    font=("times new roman", 20, "bold"),bg = "cyan", fg="red", pady=5)
title_label.pack()

#==============Customer=============
customer_frame = LabelFrame(root,text="Customer Details",font=("times new roman", 15, "bold"),
                            bd=8, bg="cyan", relief=GROOVE)
customer_frame.pack(side=TOP, fill="x")

customer_name_label = Label(customer_frame, text="Name", 
                    font=("arial", 15, "bold"),bg = "cyan", fg="blue")
...
#===============Menu===============
menu_frame = Frame(root,bd=8, bg="cyan", relief=GROOVE)
menu_frame.place(x=0,y=125,height=585,width=680)

menu_label = Label(menu_frame, text="Menu", 
                    font=("times new roman", 20, "bold"),bg = "cyan", fg="red", pady=0)
menu_label.pack(side=TOP,fill="x")

menu_category_frame = Frame(menu_frame,bg="cyan",pady=10)
menu_category_frame.pack(fill="x")

combo_lable = Label(menu_category_frame,text="Select Type", 
                    font=("arial", 12, "bold"),bg = "cyan", fg="blue")
...
item_frame3 = Frame(item_frame, bg="cyan")
...
#==============Order Frame=====================
order_frame = Frame(root,bd=8, bg="cyan", relief=GROOVE)
